...
#
# Original: alternates/math_dapo.py
...
def score_fn(model_output: str, expected_answer: str) -> float:
    ...
    Returns 1.0 for correct, 0.0 for incorrect (normalized from original -1.0/1.0).
    """
    result = compute_score(model_output, expected_answer)
    return 1.0 if result["acc"] else 0.0
